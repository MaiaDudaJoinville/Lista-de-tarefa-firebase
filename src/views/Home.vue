<template>
  <v-container class="pa-8" fluid>
    <h1 class="h1 text-center">Lista de tarefas</h1>
    <v-form>
      <v-container>
        <v-text-field label="Insira uma nova tarefa" v-model="novaTarefa">
          <v-icon slot="append" @click="adicionar">mdi-checkbox-marked-circle</v-icon>
        </v-text-field>
      </v-container>
    </v-form>
    <v-divider></v-divider>
