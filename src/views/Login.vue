<template>
  <v-container fill-height fluid text-center>
    <v-container>
      <v-row>
        <v-col
          class="warning--text text-center mx-auto"
          clos="1"
          sm="4"
          ><h1 class="h1 text-decoration-underline">Login</h1>
          <p class="text-muted">Para criar uma conta, insira um e-mail e uma senha ainda não utilizados</p>
          </v-col>
      </v-row>
